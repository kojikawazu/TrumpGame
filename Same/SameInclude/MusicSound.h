#ifndef NanairoLib_SOUND_H
#define NanairoLib_SOUND_H
...
namespace NanairoLib
{
	...
	typedef std::map<std::string, NanairoLib::SEData>				BGMMap;
	typedef std::map<std::string, NanairoLib::SEData>::iterator		BGMIterator;
	typedef std::map<std::string, NanairoLib::SEData>::value_type	BGMType;

	typedef std::map<std::string, NanairoLib::BGMData>				SEMap;
	typedef std::map<std::string, NanairoLib::BGMData>::iterator	SEIterator;
	typedef std::map<std::string, NanairoLib::BGMData>::value_type	SEType;
	...
	class BGMFactory
	{
		...
		public:
			...
			//@inout : 取得するポインタ
			//@out : true(成功) false(失敗)
			__IMPOETER bool GetMusic(LPCSTR name,const NanairoLib::SEData* bgm);
	...
	class SEFactory
	{
		...
		public:
			...
			//@inout : 保存ポインタ
			//@out : true(成功) fale(失敗)
			__IMPOETER bool GetMusic(LPCSTR name,NanairoLib::BGMData* SEData);
	...
	class MusicFactory{
		...
		public:
			//********************************************************
			//読み取り用
			__IMPOETER BGMFactory* GetBGM() const{			return	_bgm;			}
			__IMPOETER SEFactory* GetMUSIC() const{			return _sound;			}
			//********************************************************
